#!/usr/bin/env python3
"""
RAG System - Core RAG Implementation with sqlite-vec
LocalRAGSystem class with embedding generation, vector search, context retrieval
"""
...
class LocalRAGSystem:
    """Complete RAG implementation with sqlite-vec integration"""
    ...
    def __init__(self, db_path=None):
        ...
        logger.info(f"RAG System initialized with database: {self.db_path}")
    ...
    def add_documents(self, text_chunks, source="unknown"):
        ...
        try:
            ...
            for i, chunk in enumerate(text_chunks):
                ...
                cursor.execute(
                    "INSERT INTO documents (content, source, chunk_index, metadata) VALUES (?, ?, ?, ?)",
                    (chunk, source, i, json.dumps({"length": len(chunk)}))
                )
